...
import { Mail, Lock, Loader2, ArrowRight, Eye, EyeOff, Brain } from 'lucide-react'
...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-aurora bg-grid flex items-center justify-center px-4">
